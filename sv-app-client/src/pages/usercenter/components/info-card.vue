  ...
  <view class="info-card">
    ...
    <view class="user-info">
      <view class="user-avatar">
        <uv-avatar
          ...
          @click="skipPage('/pages/usercenter/userinfo', true)"
        ></uv-avatar>
      </view>
      <view class="info-edit">
        ...
        <button class="margin-top cu-btn sm block line-cyan" @click="skipPage('/pages/usercenter/userinfo', true)">
          编辑资料
        </button>
      </view>
    </view>
    <view class="user-intro">
      <view class="flex-vc justify-between">
        <text class="text-bold text-xl">{{ userInfo?.nickname || '起个昵称吧' }}</text>

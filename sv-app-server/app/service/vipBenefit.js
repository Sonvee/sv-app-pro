...
class VipBenefitService extends Service {
  ...
  async benefitAdd(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['benefitAdd'])
  ...
  async benefitUpdate(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['benefitUpdate'])
  ...
  async benefitDelete(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['benefitDelete'])
  ...
  async benefitBatchAdd(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['benefitBatchAdd'])
  ...
  async benefitBatchDelete(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['benefitBatchDelete'])

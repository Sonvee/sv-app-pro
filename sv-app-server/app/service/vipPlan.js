...
class VipPlanService extends Service {
  ...
  async planAdd(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['planAdd'])
  ...
  async planUpdate(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['planUpdate'])
  ...
  async planDelete(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['planDelete'])
  ...
  async planBatchAdd(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['planBatchAdd'])
  ...
  async planBatchDelete(data) {
    ...
    // 权限校验
    ctx.checkAuthority('permission', ['planBatchDelete'])

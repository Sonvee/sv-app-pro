...
export const useDatabaseInit = () => {
  menuBatchAdd({ list: menuData.data })
  roleBatchAdd({ list: roleData.data })
  permissionBatchAdd({ list: permissionData.data })
  dictBatchAdd({ list: dictData.data })
  dictitemBatchAdd({ list: dictitemData.data })
}
